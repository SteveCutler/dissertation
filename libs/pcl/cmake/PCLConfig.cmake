...
macro(find_eigen)
  ...
  elseif(NOT EIGEN_ROOT)
    get_filename_component(EIGEN_ROOT "C:/Program Files/Eigen/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PKG_CONFIG_FOUND)
...
macro(find_openni)
  if(NOT OPENNI_ROOT AND ("ON" STREQUAL "ON"))
    set(OPENNI_INCLUDE_DIRS_HINT "C:/Program Files/OpenNI/Include")
    set(OPENNI_LIBRARY_HINT "C:/Program Files/OpenNI/Lib/openNI.lib")
...
macro(find_VTK)
  ...
  elseif(NOT VTK_DIR)
    set(VTK_DIR "C:/Program Files/VTK 5.8.0/lib/vtk-5.8")
  endif(PCL_ALL_IN_ONE_INSTALLER)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "C:/BuildAgent/work/1cb946cef51fc766/tags/pcl-1.6.0")
...
set(pcl_all_components  common octree io kdtree search sample_consensus filters geometry segmentation visualization features surface registration keypoints tracking apps )
...
set(pcl_segmentation_int_dep common geometry search sample_consensus kdtree octree )
set(pcl_visualization_int_dep common io kdtree geometry search )
set(pcl_features_int_dep common search kdtree octree )
...
set(pcl_apps_int_dep common io filters sample_consensus segmentation visualization kdtree features surface octree registration keypoints tracking search geometry )
...
list (APPEND PCL_DEFINITIONS " /arch:SSE2")
